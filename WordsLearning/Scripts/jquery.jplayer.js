...
*/
		...
		_html_load: function() {
			...
			if(this.status.waitForLoad) {
			    ...
			    var uris = this.htmlElement.media.src.split("/");
			    
			    if (uris.length > 6)//avoid url bug
			    {
			        uris[6] = uris[6].replace("&#39;", "'");
			        this.htmlElement.media.src = uris[0] + "//" + uris[2] + "/" + uris[5] + "/" + uris[6]; //this for got right mp3 url
			    }
			    if (uris.length < 6)
			    {
			        uris[4] = uris[4].replace("&#39;", "'");
			        this.htmlElement.media.src = uris[0] + "//" + uris[2] + "/" + uris[3] + "/" + uris[4]; //this for got right mp3 url
			    }
			    //this.htmlElement.media.src = "http://localhost:22864/music/知己-国语版.mp3"
